...
class CAMInterp():
    ...
    def ResidueAnalysis(self, cam_threshold, importance_threshold):
        ...
        self._importance_polymorphism_plot(cam_threshold, residue_dict,
    ...
    def _importance_polymorphism_plot(self, cam_threshold, position_dict, figsize=(3.5,3.5), s=2, figfile=None):
        # figure
        df = pd.DataFrame()
        fig, ax = plt.subplots(1, figsize=figsize, dpi=self.dpi)
        ...
        label_list = ['selected', '34-residue']
